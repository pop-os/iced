...
/// Messages specific to the [`EventContainer`]
...
/// A container intercepting events
///
/// It is normally used for alignment purposes.
#[allow(missing_debug_implementations)]
pub struct EventContainer<'a, Message, Renderer>
where
...
impl<'a, Message, Renderer> EventContainer<'a, Message, Renderer>
where
    Renderer: crate::Renderer,
    Renderer::Theme: StyleSheet,
{
    /// Creates an empty [`EventContainer`].
...
impl<'a, Message, Renderer> Widget<Message, Renderer>
    for EventContainer<'a, Message, Renderer>
where
    Renderer: crate::Renderer,
    Renderer::Theme: StyleSheet,
    Message: Clone,
{
    ...
    fn on_event(
        ...
        update(event, layout, cursor_position, shell, &self.messages)
    }
...
impl<'a, Message, Renderer> From<EventContainer<'a, Message, Renderer>>
...
{
    fn from(
        column: EventContainer<'a, Message, Renderer>,
    ) -> Element<'a, Message, Renderer> {
        Element::new(column)
    }
}

/// Computes the layout of a [`EventContainer`].
...
/// Processes the given [`Event`] and updates the [`State`] of an [`EventContainer`]
/// accordingly.
fn update<Message: Clone>(
    ...
    // TODO: Lazy initialize with once_cell::Lazy.
