...
impl<'a, Message, Renderer, Handle> Widget<Message, Renderer> for Image<'a, Handle>
where
    Renderer: image::Renderer<Handle = Handle>,
    Handle: Clone + Hash,
{
    ...
    fn a11y_nodes(&self, layout: Layout<'_>, _state: &Tree, _cursor_position: Point) -> iced_accessibility::A11yTree {
        use iced_accessibility::{accesskit::{Rect, NodeBuilder, Role, NodeId}, A11yTree, A11yNode};
